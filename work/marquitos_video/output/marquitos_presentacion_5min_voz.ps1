...
$s.Rate = 0
$s.Volume = 100
$s.SetOutputToWaveFile('C:\Users\Qrent_395\Documents\Codex\javiweb\work\marquitos_video\output\marquitos_presentacion_5min_voz.wav')
$s.Speak((Get-Content -LiteralPath 'C:\Users\Qrent_395\Documents\Codex\javiweb\work\marquitos_video\output\marquitos_presentacion_5min_voz.txt' -Raw -Encoding UTF8))
$s.Dispose()
