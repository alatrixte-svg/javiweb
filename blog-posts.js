window.BLOG_POSTS = [
  {
    ...
    "date": "2026-08-26",
    "titulo": "El río Blanqueo",
    "extracto": "Un día de verano en el río Blanqueo reúne baños helados, comidas interminables y la familia al completo. Entre cronómetros de digestión, sandías monumentales y galletas del Príncipe, la infancia recupera su humor y su grandeza. La memoria convierte aquella ensenada de Granada en un lugar que sigue cálido, incluso frente a doña ELA.",
    "cuerpo": [
  ...
  },
  {
    ...
    "titulo": "Se vota el lunes. El texto, ya si eso",
    "extracto": "A tres días del Pleno del Senado, la reforma de la Dependencia y la Discapacidad se votará sin que la ciudadanía conozca el texto definitivo.",
    "cuerpo": [
  ...
  },
  {
    ...
    "titulo": "A buenos vasallos, buenos señores",
    "extracto": "La tendencia de algunos medios a plegarse a la voluntad del poder",
    "cuerpo": [
  ...
  },
  {
    ...
    "titulo": "Leyes de goma o de granito",
    "extracto": "Va sobre la facilidad política de malear las leyes a su interés o considerarlas pétreas e infranqueables cuando no hay rédito a la vista.",
    "cuerpo": [
  ...
  {
    "id": "post-a-la-directora-general-de-autonomia",
    "fecha": "1 de julio de 2026",
    "titulo": "A la directora general de Autonomía",
    "extracto": "Comentarios a una entrevista",
    "cuerpo": [
  ...
  {
    "id": "post-la-bolsa-o-la-vida",
    "fecha": "27 de junio de 2026",
    "titulo": "La bolsa o la vida",
    "extracto": "Una nueva modalidad de la frase, pero mucho menos romántica",
    "cuerpo": [
      "La bolsa o la vida",
      ...
      "Por suerte, cuando mis ojos ya estaban a punto de sangrar ante tan desafortunada visión, mi mente ha venido al rescate para sacarme de mi engaño y me ha dicho: “No te atormentes, éstos son más de traje y coche oficial que de torerita o leotardos. Además, aquéllos robaban a los ricos para dárselo a los necesitados, mientras que los de la nueva versión aligeran la bolsa de éstos para/por…”",
      "Que cada cual elija su propio final para esta última frase. Hace tiempo que yo ya tengo el mío."
    ],
    "etiqueta": "ELA"
  },
  {
    "id": "post-cinderela-y-el-baile-de-los-cuidados",
    "fecha": "20 de junio de 2026",
    "titulo": "CinderELA y el baile de los cuidados",
    "extracto": "Un cuento infantil para despertar conciencias adultas",
    "cuerpo": [
  ...
  {
    "id": "post-como-un-reloj-suizo",
    "fecha": "14 de junio de 2026",
    "titulo": "Como un reloj suizo",
    "extracto": "La maquinaria no ajusta en Drets Socials",
    "imagen": "assets/OAP-GI.jpg",
    "cuerpo": [
  ...
  },
  {
    ...
    "titulo": "Hoy es Nochebuena",
    "extracto": "El sabor de mis navidades",
    "cuerpo": [
  ...
  },
  {
    ...
    "extracto": "Un nuevo espacio donde compartir lo que pienso, lo que siento y lo que no me cabe en 280 caracteres.",
    "cuerpo": [
      "Llevan años diciéndome que tengo mucho que contar. Que mi historia merece más que un libro, más que una entrevista, más que un post en redes. Y quizás tienen razón. Así que aquí estoy, abriendo este espacio.",
      "Escribo con los ojos. Cada palabra me cuesta un esfuerzo que quizás vosotros nunca podréis imaginar, y que yo ya no puedo evitar. Porque si hay algo que la ELA no me ha quitado — y que no me quitará — es la necesidad de decir.",
      "En este blog encontraréis opinión, reflexión y, a veces, cabreo. Sobre la enfermedad, sobre la justicia, sobre el amor, sobre la vida. Sin filtros. Sin poses. Solo yo, mis ojos y el cursor.",
      "Gracias por estar aquí."
    ],
    "etiqueta": "Reflexión"
  },
  {
    "id": "post-el-copago-y-las-deducciones-esa-veleta-con-escano",
    "fecha": "7 de junio de 2026",
    "titulo": "El copago y las deducciones, esa veleta con escaño",
    "extracto": "La hipocresía de los sepulcros blanqueados",
    "cuerpo": [
      "Hay momentos en los que la política española alcanza tal nivel de virtuosismo teatral que uno no sabe si está viendo un pleno parlamentario o una reposición de La vida de Brian con subvenciones autonómicas a tutiplén. La Asamblea Regional de Murcia convalidó el decreto ley de atención a la ELA con los votos de PP, Vox y Grupo Mixto, mientras el PSOE optó por la abstención —una más— y denunció que el texto “oculta” y “ampara” el copago en las prestaciones de dependencia extrema.",
      "Hasta ahí, la escena habitual: reproches, solemnidad, ceños fruncidos y esa gravedad institucional que suele durar exactamente hasta que se ven las caras en la cafetería y comparten unas ensaimadas rellenas de falsedad con un café bien cargado de hipocresía.",
      "Lo verdaderamente admirable —permítaseme la ironía, porque de lo contrario habría que echarse a llorar— es la capacidad de nuestros partidos para descubrir principios morales justo cuando se sientan en la oposición. Desde allí, todo se ve cristalino: el Gobierno murciano “elude su responsabilidad”, muestra “incapacidad” para presentar presupuestos y exhibe “falta de gobierno”. Curioso. Uno cierra los ojos y le parece haber visto esos mismos dardos volando en dirección contraria por la capital del Reino, lanzados con idéntica puntería, distinta chaqueta y el mismo desleal y manido manual de instrucciones.",
      "Pero la perla mayor llega cuando se afirma que “lo último que necesita un enfermo de ELA en fase terminal es que se le cargue con más gastos”. ¡Adiós profeta! —que diría el del chiste—. Ahí la ironía se atraganta. Porque quien vive con un grado III+ reconocido, quien espera una prestación que la ley ya le promete pero la burocracia le regatea, no contempla este debate como una partida parlamentaria de ping-pong. Lo contempla como lo que es: una espera indigna, cara y agotadora.",
      "Y entonces aparece la gran contradicción nacional: el copago y las deducciones son una atrocidad cuando los aplica el adversario, una complejidad presupuestaria cuando los sostiene el propio bando y, una lamentable herencia recibida, cuando conviene mirar hacia los de más arriba para lavarse las manos como Pilatos o simplemente al techo para disimular mientras se silba. Todos contra el copago y las deducciones, salvo cuando toca votar en la Cámara. Todos con los enfermos, salvo cuando hay que aflojar la caja. Todos con la ELA, siempre que quepa en una foto, una pancarta, una intervención de tres minutos o un titular con lágrima forzada incorporada.",
      "Lo insoportable no es solo la incoherencia. Es que nos utilicen como munición. Que quienes padecen dependencia extrema sean convertidos en argumento arrojadizo por quienes ayer callaban, hoy declaman y mañana quizá firmen exactamente lo contrario. Están, en efecto, cortados por el mismo patrón: mucho luto verbal, mucha indignación de escaparate y demasiada poca vergüenza práctica. Sepulcros blanqueados que no dudan en utilizar nuestra tragedia para medrar o para herir a los rivales.",
      "Porque al enfermo no le cura una frase brillante. No le asiste una rueda de prensa. No le levanta de la cama una acusación parlamentaria. Le ayudan recursos, derechos efectivos y prestaciones sin peajes confiscatorios. Lo demás es teatro. Y encima, del malo.",
      "Sils, 7 de junio de 2026"
    ],
    "etiqueta": "ELA"
  },
  {
    "id": "post-querer-es-poder",
    "fecha": "4 de junio de 2026",
    "titulo": "Querer es poder",
    "extracto": "Diferentes criterios autonómicos en copago y deducciones.",
    "cuerpo": [
  ...
  {
    "id": "post-acaso-fue-una-victoria-frente-a-dona-ela",
    "fecha": "25 de mayo de 2026",
    "titulo": "¿Acaso fue una victoria frente a doña ELA?",
    "extracto": "Logré asistir a la marcha «Lluitem per l’ELA» de Vilablareix pese al dolor, el insomnio y la fragilidad que me impone la enfermedad.",
    "imagen": "assets/javi_vilablareix.png",
    "cuerpo": [
      "La mañana de ayer amaneció envuelta en una extraña bruma emocional. Se celebraba la tercera marcha de Vilablareix, «Lluitem per l’ELA», bajo el abrazo incombustible de la gente de Hofemxtu tu. Hasta ahora, mi presencia allí había sido un ritual inquebrantable sostenido sobre dos pilares: el clamor urgente por la investigación para doblegar a esta maldita enfermedad, y la imperiosa necesidad de mi alma de reencontrarse con rostros amigos. Era, además, el escenario perfecto para saldar mi deuda de gratitud con esos voluntarios que, durante meses, tejen en la sombra este milagro solidario.",
  ...
  {
    "id": "post-aliento-no-obstaculos-ni-muros-infranqueables",
    "fecha": "24 de mayo de 2026",
    "titulo": "Aliento, no obstáculos ni muros infranqueables.",
    "extracto": "Lo que nuestros gobernantes no entienden sobre vivir con ELA.",
    "cuerpo": [
      "Como lo prometido es deuda, aquí va la 2a entrega sobre la #LeyELA. Ésta va dirigida a quienes pueden revertir la situación. Está en su mano, sin excusas. Hoy sí que os pido que lo difundáis, que les llegue, que se sepa. Gracias.",
  ...
  {
    "id": "post-luces-y-sombras-de-la-ley-ela",
    "fecha": "23 de mayo de 2026",
    "titulo": "Luces y sombras de la Ley ELA.",
    "extracto": "El copago enmascarado que nadie explica",
    "cuerpo": [
  ...
  {
    "id": "post-el-desprecio-institucional-hecho-oficio",
    "fecha": "14 de mayo de 2026",
    "titulo": "El desprecio institucional hecho oficio.",
    "extracto": "La muerte de guardias civiles en acto de servicio merece el máximo respeto.",
    "cuerpo": [
      "Admitir un «error de cálculo» cuando el suelo aún está tibio por el entierro de tres servidores públicos es el culmen del cinismo político. En Moncloa, parece que la sensibilidad se mide en encuestas y no en decencia. Que el ministro del Interior, Fernando Grande-Marlaska, prefiriera escudarse en la gestión de un virus mientras los guardias civiles que dependen de su cartera eran cazados en el mar, no es un fallo de agenda; es una declaración de principios: la de un Ejecutivo que solo mira al uniforme cuando necesita un cordón de seguridad para que no lo inquieten o lo critiquen en las distancias cortas.",
      "La desvergüenza y el desprecio alcanzaron su cenit con María Jesús Montero y su infame «accidente laboral». Tratar una ejecución premeditada mediante embestida como si fuera un traspié en una oficina es, cuando menos, escupir sobre el pundonor y la entrega de quienes, armados con piedras y palos y maniatados por las órdenes políticas, han de enfrentarse a delincuentes dotados de medios sofisticados y sin restricciones en sus reglas de combate. Rectificar a regañadientes no borra el rastro de una pútrida mentalidad que, en su obtusa visión del mundo, ve en las muertes de estos guardias civiles un simple contratiempo administrativo, un incidente menor que afea la estadística e irrumpe incómodamente en su divina misión de recolectar votos para su candidatura.",
      "Este Gobierno padece de una miopía crónica. Es incapaz de ver más allá de la próxima semana parlamentaria y de la encuesta de intención de voto, abandonando a su suerte, mientras tanto, a quienes protegen nuestras vidas, nuestros bienes y nuestras costas y fronteras.",
      "Y ante este reciente y consternador incidente que ha segado tres vidas y destrozado idéntico número de familias, la palabra «dimisión»es una entelequia, un espejismo en medio de un inmenso desierto. En la política descarnada de hoy parece haberse instalado la idea de que la dimisión no es una salida digna, sino una debilidad prohibida. Es un: «antes muertos que sin silla» y, el señor Marlaska, fiel discípulo de tan santificada filosofía, antes dejaría caer el prestigio de toda una institución que su propia cabeza.",
      "Como si un pintor mediocre se hubiese encargado de plasmar la realidad, nos ha quedado un cuadro desolador: agentes en inferioridad de condiciones, ministros en superioridad de soberbia y una administración que confunde la paciencia y la resiliencia de los ciudadanos con su propia impunidad. Su indolencia no es un error puntual, sino, por desgracia, su marca de agua permanente.",
      "Besos al cielo para los tres compañeros y abrazos sentidos para sus familias."
    ],
    "etiqueta": "Reflexión"
  },
  {
    ...
    "titulo": "A mi madre",
    "extracto": "Cada día del año es el día de la madre",
    "cuerpo": [
  ...
  {
    "id": "post-caer-y-levantarse",
    "fecha": "10 de abril de 2026",
    "titulo": "Caer y levantarse",
    "extracto": "Doña ELA insiste en arrodillarme, yo en todo lo contrario.",
    "cuerpo": [
  ...
  {
    "id": "post-necesitamos-prestaciones-y-nos-dan-copagos-y-deducciones",
    "fecha": "26 de diciembre de 2025",
    "titulo": "Necesitamos prestaciones y nos dan copagos y deducciones",
    "extracto": "Traicionar a los enfermos debe ser pecado mortal.",
    "cuerpo": [
